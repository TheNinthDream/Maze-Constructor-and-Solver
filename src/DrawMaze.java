...
public class DrawMaze extends JFrame{
  ...
  private final Color rockColor = new Color(80,70,50);
  private final Color wallColor = new Color(255,100,100);
  private final Color pathColor = new Color(255,0,0);
  private final Color entranceColor = new Color(100,100,100);
  private final Color exitColor = new Color(100,255,100);
  private final Color backColor = new Color(195,195,215);
  private final Color white = new Color(255,255,255);
  private final Color door = new Color(128,60,60);
  private final Color openDoor = new Color(255,255,255);
  private final Color black = new Color(0,0,0);
  private final Color[] doorColors = new Color[10];
  ...
  /* ============================= */
    ...
    try {
      ...
      //input = new BufferedReader(new FileReader(labFile));
        //changes
       input = new BufferedReader(new FileReader("C:\\Users\\Abeer Khurram\\Docs\\Assignments\\Data Structures and Algorithms\\Assignment 5\\GraphMaze\\maze3.txt"));
      ...
      //changes -r as in revised
      name = "person.gif";
      img = ImageIO.read(new File("C:\\Users\\Abeer Khurram\\Docs\\Assignments\\Data Structures and Algorithms\\Assignment 5\\GraphMaze\\person.gif"));
      name = "personb.gif";
      imgb = ImageIO.read(new File("C:\\Users\\Abeer Khurram\\Docs\\Assignments\\Data Structures and Algorithms\\Assignment 5\\GraphMaze\\personb.gif"));
      name = "rock3.jpg";
      rock = ImageIO.read(new File("C:\\Users\\Abeer Khurram\\Docs\\Assignments\\Data Structures and Algorithms\\Assignment 5\\GraphMaze\\rock3.jpg"));
      drawMaze(input);
      ...
      if (coins == 0) display.drawString("No coins available",offset,2*labLength*roomSize+2);
      	 ...
      	 display.drawString("Available coins : "+ coins,offset,2*labLength*roomSize+offsety);
    }
    catch (InterruptedException e) {
      System.out.println("Error starting program");
      e.printStackTrace(); //changes -k as in kept
    }
    catch (IOException e) {
	imageFile = false;
	System.out.println("Cannot read image file: "+name);
    e.printStackTrace(); //changes -k
    }
    catch (Exception e) {
 ...
 /* ================================================================= */
  ...
  /* Input: edge (uv) */
     ...
     if (imageFile)
         drawPerson((vs % labWidth)*2*roomSize,(vs / labWidth)*2*roomSize, (us % labWidth) <= (vs % labWidth));
